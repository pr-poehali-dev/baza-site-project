        ...
        return (
          <div className="space-y-12">
            <div className="text-center space-y-6">
              <div className="text-[120px] leading-none font-black tracking-tighter mb-4" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                БА<span className="inline-block">З</span>А
              </div>
              <p className="text-2xl tracking-[0.3em] font-light">ЦЕНТР КРЕАТИВНЫХ ИНДУСТРИЙ</p>
            </div>
